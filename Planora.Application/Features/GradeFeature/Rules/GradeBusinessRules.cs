...
{
    public async Task GradeShouldExistWhenRequestedAsync(Grade grade)
    {
        if (grade is null)
    ...
    public async Task GradeNameMustBeUniqeWhenCreateAsync(string name)
    {
    ...
    public async Task GradeNameMustBeUniqueWhenUpdateAsync(Guid id, string name)
    {
