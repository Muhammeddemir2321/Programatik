    ...
    : IRequestHandler<UpdateOperationClaimCommand, UpdatedOperationClaimDto>
{
    ...
    {
        var mailDesign = await operationClaimRepository.GetAsync(m => m.Id == request.Id, cancellationToken: cancellationToken);
        ...
        var updatedOperationClaim = await operationClaimRepository.UpdateAsync(mappedOperationClaim, cancellationToken);
