...
{
    public async Task TeacherShouldExistWhenRequested(Teacher teacher)
    {
        if (teacher is null)
    ...
    public async Task TeacherFullNameMustBeUniqeWhenCreate(string fullName)
    {
    ...
    public async Task TeacherFullNameMustBeUniqueWhenUpdate(Guid id, string fullNAme)
    {
