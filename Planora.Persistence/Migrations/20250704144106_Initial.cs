    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeacherUnavailables", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClassSections_Schools_SchoolId",
                        column: x => x.SchoolId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lectures_Schools_SchoolId",
                        column: x => x.SchoolId,
                        principalTable: "Schools",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LessonScheduleGroup", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LessonScheduleGroup_Schools_SchoolId",
                        column: x => x.SchoolId,
                        principalTable: "Schools",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeeklyLessonDayCount = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SchoolId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LessonScheduleGroupId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ClassSectionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DayOfWeek = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LessonSchedule_ClassSections_ClassSectionId",
                        column: x => x.ClassSectionId,
                        principalTable: "ClassSections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LessonSchedule_Lectures_LectureId",
                        column: x => x.LectureId,
                        principalTable: "Lectures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LessonSchedule_LessonScheduleGroup_LessonScheduleGroupId",
                        column: x => x.LessonScheduleGroupId,
                        principalTable: "LessonScheduleGroup",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LessonSchedule_Schools_SchoolId",
                        column: x => x.SchoolId,
                        principalTable: "Schools",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LessonSchedule_Teachers_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "Teachers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassSections_SchoolId",
                table: "ClassSections",
                column: "SchoolId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonSchedule_ClassSectionId",
                table: "LessonSchedule",
                column: "ClassSectionId");

            migrationBuilder.CreateIndex(
                name: "IX_LessonSchedule_LectureId",
                table: "LessonSchedule",
                column: "LectureId");

            migrationBuilder.CreateIndex(
                name: "IX_LessonSchedule_LessonScheduleGroupId",
                table: "LessonSchedule",
                column: "LessonScheduleGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_LessonSchedule_SchoolId",
                table: "LessonSchedule",
                column: "SchoolId");

            migrationBuilder.CreateIndex(
                name: "IX_LessonSchedule_TeacherId",
                table: "LessonSchedule",
                column: "TeacherId");

            migrationBuilder.CreateIndex(
                name: "IX_LessonScheduleGroup_SchoolId",
                table: "LessonScheduleGroup",
                column: "SchoolId");
